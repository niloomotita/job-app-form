    ...
    render (){
        return (
            <form action="submit" className="portfolio-form">
                <p className="paragraph-portofolio">Prove you are IBM's next great designer by showing us who you are. What you've done. How you think. Tell us your
                        story.</p>
                        <input 
                            ...
                            onChange={(e)=>{this.setState({portofolio: e.target.value})}}
                        />
                        <textarea 
